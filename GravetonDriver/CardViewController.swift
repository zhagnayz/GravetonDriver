...
class CardViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "chevron.backward"), style: .done, target: self, action: #selector(didTapMainButton))
    ...
    @objc func didTapSendOrderButton(){
        ...
        if let indexPath = indexPath {
            ...
            let ref = Database.database().reference().child("user-orders").child(admins[indexPath.item].restId!)
