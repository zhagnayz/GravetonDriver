...
class PriceDetailsCell: UICollectionViewCell {
    ...
    func configurePricceDetail(_ orderHistory: Order){
        ...
        deliveryChargeLabel.text = "\(orderHistory.formattedDeliveryCharge)"
        tipLabel.text = "\(orderHistory.formattedTip)"
        taxLabel.text = "\(orderHistory.formattedTax)"
        grandTotalLabel.text = "\(orderHistory.formattedGrandTotal)"
    }
